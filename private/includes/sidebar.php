<aside id="sidebar-wrapper" class="text-light shadow d-flex flex-column" style="min-height: calc(100vh - 60px);">
    ...
    <div class="list-group list-group-flush mt-2">
        <a href="<?= BASE_URL ?>/private/dashboard.php" class="list-group-item list-group-item-dark p-3 border-0 <?= isActive('dashboard.php', $current_path) ?>">
            <i class="fa-solid fa-chart-line me-2"></i> Dashboard
        </a>

        <a href="<?= BASE_URL ?>/private/views/equipamento/index.php"
            class="list-group-item list-group-item-dark p-3 border-0 <?= isActive('/equipamento/', $current_path) ?>">
        ...
        <?php if ($_SESSION['user_perfil'] === 'Admin' || $_SESSION['user_perfil'] === 'Tecnico'): ?>
            <a href="<?= BASE_URL ?>/private/views/localizacoes/index.php"
                class="list-group-item list-group-item-dark p-3 border-0 <?= isActive('/localizacoes/', $current_path) ?>">
        ...
        <?php if ($_SESSION['user_perfil'] === 'Admin'): ?>
            <a href="<?= BASE_URL ?>/private/views/users/index.php"
                class="list-group-item list-group-item-dark p-3 border-0 <?= isActive('/users/', $current_path) ?>">
