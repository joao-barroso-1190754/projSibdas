                    ...
                    <div class="row g-3 mb-4">
                        ...
                        <div class="col-md-4">
                            ...
                            <select class="form-select" name="categoria">
                                ...
                                <option value="Laboratório" <?= ($eq['categoria'] == 'Laboratório') ? 'selected' : '' ?>>
                                    Laboratório</option>
                    ...
                    <div class="row g-3 mb-4">
                        ...
                        <div class="col-md-4">
                            ...
                            <select class="form-select" name="estado" required>
                                ...
                                <option value="Em manutenção" <?= ($eq['estado'] == 'Em manutenção') ? 'selected' : '' ?>>
                                    Em manutenção</option>
                                <option value="Inativo" <?= ($eq['estado'] == 'Inativo') ? 'selected' : '' ?>>Inativo
                                </option>
                                <option value="Abatido" <?= ($eq['estado'] == 'Abatido') ? 'selected' : '' ?>>Abatido
                                </option>
                            </select>
                        </div>
                        <div class="col-md-4">
                            ...
                            <select class="form-select" name="criticidade">
                                <option value="Baixa" <?= ($eq['criticidade'] == 'Baixa') ? 'selected' : '' ?>>Baixa
                                </option>
                                <option value="Média" <?= ($eq['criticidade'] == 'Média') ? 'selected' : '' ?>>Média
                                </option>
                        ...
                        <div class="col-12 mt-3">
                            ...
                            <textarea class="form-control" name="observacoes"
                                rows="2"><?= htmlspecialchars($eq['observacoes'] ?? ''); ?></textarea>
                        </div>
                    </div>
